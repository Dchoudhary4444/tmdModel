...
/*
CREATE USER 'tmdModel'@'localhost' IDENTIFIED BY 'tmdModel';
GRANT ALL PRIVILEGES ON * . * TO 'tmdModel'@'localhost';
FLUSH PRIVILEGES;


move to tmdModel/db folder and using mysql  login as newly created user and create database named tmdModel

create database tmdModel;
use tmdModel;
source tmdModel.sql;


in future add these two column in project table
