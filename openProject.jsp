...
{
$.ajax('/tmdModel/webservice/projectService/populateDS',{
type:"Post",
...
$.ajax('/tmdModel/webservice/projectService/saveProject',{
type:"POST",
...
if(databaseTableField.isNotNull) constraints=" NN ";
if(databaseTableField.isPrimaryKey) constraints+=" PK ";
if(databaseTableField.isUnique) constraints+=" UNQ ";
if(databaseTableField.isAutoIncrement) constraints+=" ++ ";
...
<c:forEach var="message" items="${applicationScope.databaseEngines}">
...
<c:forEach var="message" items="${sessionScope.openProjectList.getDatabaseArchitecture().getDataType()}">
<option value="${message.code}">${message.dataType}</option>
</c:forEach>
</select>
</div>
...
<button type="button" id="addNewField" style="padding:10px 10px" class="btn btn-default" data-toggle="tooltip" title="Add" id="addField" onclick='addRow()'><img src='/tmdModel/images/add.png'></img></button>
...
<input type="text" id="editDefaultText" name="defaultValue" class="form-control" placeholder="Enter Field Name" required="required" autofocus="autofocus" style="width:200px;">

<label for="editDefaultText">Default Value</label>
...
<th style="padding:50px">
<button type="button" id="updateAttribute" style="padding:10px 10px" class="btn btn-default" data-toggle="tooltip" title="Update"  onclick='updateAttribute()'><img src='/tmdModel/images/edit.png'></img></button>
...
<button type="button" id="deleteAttribute" style="padding:10px 10px" class="btn btn-default" data-toggle="tooltip" title="delete"  onclick='deleteAttribute()'><img src='/tmdModel/images/delete.png'></img></button>
